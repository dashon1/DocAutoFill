# Supabase Database Schema for DocAutofill
...
All tables need Row Level Security policies to ensure users can only access their own data.

## Functions to Create

- Automatic profile creation trigger
- Data encryption functions for sensitive information
